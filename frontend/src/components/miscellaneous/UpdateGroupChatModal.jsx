...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain,fetchMessages }) => {
  ...
  const handleRemove = async(user1) => {
    ...
    try {
      ...
      const {data} = await axios.put('https://chat-app-1-srgd.onrender.com/api/chat/groupremove', {
  ...
  const handleAddUser = async(user1) => {
    ...
    try {
      ...
      const {data} = await axios.put('https://chat-app-1-srgd.onrender.com/api/chat/groupadd', {
        chatId:selectedChat._id,
        userId: user1._id,
      }, config);
