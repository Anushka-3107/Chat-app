...
const SingleChat = ({fetchAgain,setFetchAgain}) => {
    ...
    const fetchMessages = async() => {
      ...
      try {
         ...
         const {data} = await axios.get(`https://chat-app-1-srgd.onrender.com/api/message/${selectedChat._id}`, config);
    ...
    const sendMessage = async(event) => {
      if(event.key === "Enter" && newMessage ){
        ...
        try {
         ...
         setNewMessage("");
         const {data} = await axios.post("https://chat-app-1-srgd.onrender.com/api/message",
            {
            content:newMessage,
    ...
    const typingHandler = (e) => {
      ...
      setTimeout(()=>{
        ...
        var timeDiff = timeCurrent - lastTypingTime;
